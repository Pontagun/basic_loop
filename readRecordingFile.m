function [label,t,Stillness,GyroXYZ,AcceleroXYZ,MagnetoXYZ,alpha,mu] = readRecordingFile(FILENAME)

label=FILENAME;
fileID = fopen(FILENAME);
readCell=textscan(fileID,'%f %f %f %f %f %f %f %f %f %f %f %f %f ','delimiter',',');
fclose(fileID);
